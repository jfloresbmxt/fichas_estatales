...
class EXPORTACIONES:
    ...
    def __read_data(self):
        ...
        df = (pd.read_csv("data/exportaciones/eef_trimestral_tr_cifra_2007_2023.csv",
                          usecols = cols,
                         dtype=types)
                         .fillna(0)
    ...
    def filter(self):
        ...
        df.entidad = df.entidad.apply(lambda x: x.capitalize())
    ...
    def gen_entidad(self, entidad: str = "Aguascalientes"):
        ...
        monto_estatal = round(df.loc["2022", "monto"])
        ...
        monto_estatal = int(monto_estatal)
        crecimiento = round(crecimiento, 1)
        r_estatal = round(r_estatal)
